  ...
  >
    <Container>
      <Box sx={{ maxWidth:{xs:480,sm:480,md:540} , margin:{xs:"0 auto", md:"unset"}, color: '#fff', textAlign: { xs: 'center', md: 'left' } }}>
        ...
        <Button className="LaunchButton" variant="contained" color="warning" sx={{fontWeight: 600, backgroundColor: '#FCC141', color: '#180531', px: 3, py: 1, my: 3, mx: 'auto', display: { xs: 'block', md: 'none' } }}>
          Launch App
        </Button>
        </div>
