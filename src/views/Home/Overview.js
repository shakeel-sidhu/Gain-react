...
const Overview = () => (
  ...
  >
    <Container>
      <Box sx={{ maxWidth: 480, color: '#fff', textAlign: { xs: 'center', md: 'left' } }}>
        <Typography variant='h2' sx={{ lineHight:"75px",fontWeight: 500, fontSize: { xs: 36, md: 70 }, mb: 3, px: { xs: 6, md: 0 } }}>Experience the New Era of NFT to earn.</Typography>
